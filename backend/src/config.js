...
export const GLPI_API_URL = process.env.GLPI_API_URL || 'xxxxxxxx'; // URL da API GLPI
export const GLPI_APP_TOKEN = process.env.GLPI_APP_TOKEN || 'xxxxxxx'; // Token do aplicativo GLPI
